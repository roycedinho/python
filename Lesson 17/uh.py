...
upload = Image.open(r"C:\Users\royce\python-new\Lesson 17\backgroundimage.png")
...
# Function to display a message box and proceed
def msg():
...
# Function for opening new/topwindow
def topwin():
    top = Toplevel()
    ...
    label = Label(top, text="Enter total amount", bg="pink")
    entry = Entry(top)
    ...
    btn = Button(top, text="Calculate", command=calculator, bg='green', fg='white')
